...
class wifi_iperf_py(object):
	...
	def strftime(self):
		return parameter_setting.get('project_name', 'name') + '_wifi_iperf_py_' + \
				datetime + '.log'

if __name__ == '__main__':
	wifi_iperf_py = wifi_iperf_py()
	wifi_iperf_py.iperf_thread()
	os.system('adb kill-server')
	os.system('adb start-server')
	os.system('adb devices')
	j = wifi_iperf_py.finddevices_set()
	if j is False:
		os.system('adb connect ' + sys.argv[1] + ':5555')
	os.system('adb root')
	print('echo PASS >> testtool\\' + wifi_iperf_py.strftime())
	os.system('echo PASS >> testtool\\' + wifi_iperf_py.strftime())
	print('echo ' + wifi_iperf_py.strftime() + ' >> project_name.log')
	os.system('echo ' + wifi_iperf_py.strftime() + ' >> project_name.log')