...
echo 'Test_Item: cpu_wifi_iperf hardware' >> $log_patch/$project_name"_"$fun"_"$now.log &
if [ "$OpenLoop" == "true" ] ; then
...
/data/testtool/stress --cpu 4 --io 4 --vm 2 --vm-bytes 128M --timeout ${3} &
