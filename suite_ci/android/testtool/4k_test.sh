...
echo 'Test_Item: 4k_test hardware' >> $log_patch/$project_name"_"$fun"_"$now.log &
if [ "$OpenLoop" == "true" ] ; then
...
am start -a android.intent.action.VIEW -d file:///data/testtool/detail.jpg -t image/*
