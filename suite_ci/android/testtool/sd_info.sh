...
busybox busybox fdisk -l /dev/block/mmcblk0
busybox busybox fdisk -l /dev/block/mmcblk0 >> $log_patch/$project_name"_"$fun"_"$now.log &

sdinfo=`busybox fdisk -l /dev/block/mmcblk0 |grep Disk |busybox awk '{print $5}'`
