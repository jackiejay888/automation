...
@author: ZL Chen
@title: The Wireless WAN should be worked after the airplane mode by android 10.0 is switch on/off.
'''
...
config.read('.\\config\\airplane_wwan.config')


class airplane_ethernet_single(object):
...
if __name__ == '__main__':
	print('------------------------------------------------------------------------------')
	print('Created on 2020/07/09')
	print('Author: ZL Chen')
	print('Title: The Wireless WAN should be worked after the airplane mode by android 10.0 is switch on/off.')
	print('------------------------------------------------------------------------------')
