...
@author: ZL Chen
@title: The Wireless WAN should be worked after the airplane mode by android 9.0 is switch on/off.
'''
...
if __name__ == '__main__':
	...
	print('Title: The Wireless WAN should be worked after the airplane mode by android 9.0 is switch on/off.')
	print('------------------------------------------------------------------------------')
