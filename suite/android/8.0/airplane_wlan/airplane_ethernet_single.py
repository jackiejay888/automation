...
@author: ZL Chen
@title: The Wireless LAN should be worked after the airplane mode by android 8.1 is switch on/off.
'''
...
if __name__ == '__main__':
	...
	print('Title: The Wireless LAN should be worked after the airplane mode by android 8.1 is switch on/off.')
	print('------------------------------------------------------------------------------')
