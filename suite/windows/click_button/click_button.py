...
class Ui_Form_click_button(object):
    def setupUi(self, Form_click_button):
        ...
        self.enable.setGeometry(QtCore.QRect(370, 10, 120, 15))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.disable.setGeometry(QtCore.QRect(370, 25, 120, 15))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, Form_click_button):
        ...
        self.enable.setText(_translate("Form_click_button", "Shutdown Enable"))
        self.disable.setText(_translate("Form_click_button", "Shutdown Disable"))
