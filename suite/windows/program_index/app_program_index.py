...
class Ui_Form_dqa(object):
    def setupUi(self, Form_dqa):
        ...
        self.comboBox_case.setEditable(False)
    ...
    def retranslateUi(self, Form_dqa):
        ...
        item = self.listwidget_view.item(1)
        item.setText(_translate("Form_dqa", "2"))
        item = self.listwidget_view.item(2)
        item.setText(_translate("Form_dqa", "3"))
        item = self.listwidget_view.item(3)
        item.setText(_translate("Form_dqa", "4"))
